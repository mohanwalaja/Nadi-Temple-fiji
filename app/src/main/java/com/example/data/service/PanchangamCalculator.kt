...
class StandardPanchangamCalculator : PanchangamCalculator {
    ...
    override fun calculatePanchangam(
        ...
        return PanchangamDetail(
            ...
            samvatsaraNameTa = tamilSamvatsara.tamilName,
            samvatsaraNameEn = tamilSamvatsara.englishName,
            samvatsaraNameHi = tamilSamvatsara.hindiName,
            ayanam = ayanamTa,
            ritu = rituTa,
            sanskritMonth = sanskritMonth,
            sanskritMonthTa = sauraMasaTa[sunRasiIndex],
            sanskritMonthEn = sauraMasaEn[sunRasiIndex],
            sanskritMonthHi = sauraMasaHi[sunRasiIndex],
            paksha = pakshaTa,
            tithi = tithiNameTa,
